         ...
         <script src="<? echo get_template_directory_uri()?>/assets/flexslider/jquery.flexslider-min.js"></script>
          <script>            
            ...
            <div class="maxwidth-theme">
                <div id="slider" class="flexslider">
                  <ul class="slides">
                    ...
                    <li><div class="col-sm-12 col-md-6 slide-desc">
                    ...
                    <div class="bottom-mio">
                        <div class="flex-wrapper-row">
                            ...
                            <div class="pull-right">
                                <span>> 700</span>
                                <span>редких мальчиков</span>
                                <span>с миодистрофией Дюшенна  из разных уголков России нашел фонд за 5 лет работы</span>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            $percent = $percent > 100.0 ? 100.0 : $percent;?>
                                    ...
                                    <a href="<?php echo get_home_url(); ?>/zhenya-kazakevich/"><span class="btn to-help now">Помочь сейчас</span></a>
                            </div>
                       </div>
                       </li>
                       <li>
