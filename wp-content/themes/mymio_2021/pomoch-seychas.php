        ...
        <section id="leyka-form">
         <div class="maxwidth-theme">
          <div class="heading-article">
               <h1>Помочь</h1>
               <p>Спасибо, что пришли на эту страницу. Мы благодарим Вас за помощь редким детям, нашим храбрым Мио. Ваше участие меняет их настоящее и приносит надежду на будущее.</p>
           </div>
           </div>
            <div class="maxwidth-theme">
